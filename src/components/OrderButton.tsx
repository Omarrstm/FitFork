    ...
    <div>
      <div className="flex items-center gap-3 mb-4">
        ...
        <input
          ...
          className="w-20 px-3 py-1.5 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-green-500"
        />
